...
describe('TravelRuleWidget', () => {
  const session = {
    data: {
      formParameters: {
        accessToken: 'eyJ0eXAiOiJKV1QiLCJhbGciOiJFUzI1NkstUiJ9',
        nodeUrl: 'https://beta-widget.notabene.dev',
        nonCustodialDeclarationType: 'DECLARATION',
        transactionTypeAllowed: 'ALL',
        vaspDid: 'did:ethr:0x0000000000000000000000000000000000000000'
      },
      quote: {
        amount: '3.127715',
        asset: {
        ...
        destinationAddress: 'rpJoAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA',
